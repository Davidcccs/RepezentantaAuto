...
//la apasarea tastei ENTER voi afisa al consola textul adaugat in input
input.addEventListener("keyup",eveniment =>{
    if(eveniment.keyCode == 13){//tasta ENTER are codul 13
    cautare(input.value)
...
function afisareCard(masina){
     ...
     var rowCard=document.createElement("row");
